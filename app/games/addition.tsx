        ...
        <SafeAreaView style={styles.safeArea}>
          <View style={styles.completionContainer}>
            ...
            >
              ...
              <Text style={styles.completionTitle}>Addition Master!</Text>
              <Text style={styles.completionText}>
                You completed 10 addition problems!
              </Text>
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerContent}>
            ...
            <Text style={styles.subtitle}>Solve the math problems!</Text>
          </View>
...
const styles = StyleSheet.create({
  ...
  resultText: {
    ...
    textAlign: 'center',
    textShadowColor: 'rgba(0, 0, 0, 0.3)',
    textS hadowOffset: { width: 1, height: 1 },
    textShadowRadius: 2,
  },
  celebration: {
    position: 'absolute',
